...
import '/pages/chat/chat_page/chat_page_widget.dart';
              ...
              children: [
                Text(
                  FFLocalizations.of(context).getText(
                    'so9zrpky' /* Create Group Chat */,
                  ),
                  style: FlutterFlowTheme.of(context).titleMedium,
                ),
                Text(
                  FFLocalizations.of(context).getText(
                    'hztxxm0u' /* Select the friends to add to c... */,
                  ),
                        ...
                        children: [
                          ...
                          Align(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                logFirebaseEvent(
                                    'GROUP_CHAT_PAGE_SEARCH_BTN_ON_TAP');
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'GROUP_CHAT_PAGE_CREATE_CHAT_BTN_ON_TAP');
                        ...
                        await ActivityLogRecord.collection
                            ...
                            .set(createActivityLogRecordData(
                              activity:
                                  'Added people to chat - ${_model.groupChat!.users.length.toString()}',
