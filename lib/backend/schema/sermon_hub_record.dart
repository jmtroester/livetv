...
class SermonHubRecord extends FirestoreRecord {
  SermonHubRecord._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('sermon_hub');

  static Stream<SermonHubRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => SermonHubRecord.fromSnapshot(s));

  static Future<SermonHubRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => SermonHubRecord.fromSnapshot(s));

  static SermonHubRecord fromSnapshot(DocumentSnapshot snapshot) =>
      SermonHubRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static SermonHubRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      SermonHubRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'SermonHubRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is SermonHubRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createSermonHubRecordData({
  int? videoId,
  String? videoLink,
  String? sermonName,
...
class SermonHubRecordDocumentEquality implements Equality<SermonHubRecord> {
  const SermonHubRecordDocumentEquality();

  @override
  bool equals(SermonHubRecord? e1, SermonHubRecord? e2) {
  ...
  @override
  int hash(SermonHubRecord? e) => const ListEquality().hash([
        e?.videoId,
        e?.videoLink,
        e?.sermonName,
        e?.sermonThumbnail,
  ...
  @override
  bool isValidKey(Object? o) => o is SermonHubRecord;
}
